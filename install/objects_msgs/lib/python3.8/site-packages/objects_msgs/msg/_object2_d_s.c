...
bool objects_msgs__msg__object2_d__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("objects_msgs.msg._object2_d.Object2D", full_classname_dest, 36) == 0);
  }
  objects_msgs__msg__Object2D * ros_message = _ros_message;
  {  // id
...
PyObject * objects_msgs__msg__object2_d__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("objects_msgs.msg._object2_d");
