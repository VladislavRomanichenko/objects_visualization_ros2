...
{
  new (message_memory) objects_msgs::msg::Object(_init);
}

void Object_fini_function(void * message_memory)
{
  auto typed_message = static_cast<objects_msgs::msg::Object *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Object_message_member_array[5] = {
  {
    ...
    offsetof(objects_msgs::msg::Object, id),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(objects_msgs::msg::Object, label),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(objects_msgs::msg::Object, score),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(objects_msgs::msg::Object, pose),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(objects_msgs::msg::Object, size),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Object_message_members = {
  ...
  "Object",  // message name
  5,  // number of fields
  sizeof(objects_msgs::msg::Object),
...
{
  return &::objects_msgs::msg::rosidl_typesupport_introspection_cpp::Object_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, objects_msgs, msg, Object)() {
  return &::objects_msgs::msg::rosidl_typesupport_introspection_cpp::Object_message_type_support_handle;
}
