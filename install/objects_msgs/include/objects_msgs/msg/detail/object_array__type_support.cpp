...
{
  new (message_memory) objects_msgs::msg::ObjectArray(_init);
}

void ObjectArray_fini_function(void * message_memory)
{
  auto typed_message = static_cast<objects_msgs::msg::ObjectArray *>(message_memory);
  typed_message->~ObjectArray();
}

size_t size_function__ObjectArray__objects(const void * untyped_member)
{
  const auto * member = reinterpret_cast<const std::vector<objects_msgs::msg::Object> *>(untyped_member);
  return member->size();
}
...
{
  const auto & member =
    *reinterpret_cast<const std::vector<objects_msgs::msg::Object> *>(untyped_member);
  return &member[index];
}
...
{
  auto & member =
    *reinterpret_cast<std::vector<objects_msgs::msg::Object> *>(untyped_member);
  return &member[index];
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember ObjectArray_message_member_array[2] = {
  {
    ...
    offsetof(objects_msgs::msg::ObjectArray, header),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(objects_msgs::msg::ObjectArray, objects),  // bytes offset in struct
    nullptr,  // default value
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers ObjectArray_message_members = {
  ...
  2,  // number of fields
  sizeof(objects_msgs::msg::ObjectArray),
...
get_message_type_support_handle<objects_msgs::msg::ObjectArray>()
{
  return &::objects_msgs::msg::rosidl_typesupport_introspection_cpp::ObjectArray_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, objects_msgs, msg, ObjectArray)() {
  return &::objects_msgs::msg::rosidl_typesupport_introspection_cpp::ObjectArray_message_type_support_handle;
}
