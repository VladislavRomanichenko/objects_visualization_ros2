...
class Metaclass_DynamicObject(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from objects_msgs.msg import Object
...
class DynamicObject(metaclass=Metaclass_DynamicObject):
    ...
    _fields_and_field_types = {
        'object': 'objects_msgs/Object',
        'velocity': 'geometry_msgs/Twist',
        'prediction': 'sequence<geometry_msgs/PoseStamped>',
        'trajectory': 'sequence<geometry_msgs/PointStamped>',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['objects_msgs', 'msg'], 'Object'),  # noqa: E501
        ...
        if __debug__:
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 True), \
                "The 'prediction' field must be a set or sequence and each value of type 'PoseStamped'"
        ...
        if __debug__:
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 True), \
                "The 'trajectory' field must be a set or sequence and each value of type 'PointStamped'"
