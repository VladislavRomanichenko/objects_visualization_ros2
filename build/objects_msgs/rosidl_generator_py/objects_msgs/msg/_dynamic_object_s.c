...
bool objects_msgs__msg__dynamic_object__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("objects_msgs.msg._dynamic_object.DynamicObject", full_classname_dest, 46) == 0);
  }
  objects_msgs__msg__DynamicObject * ros_message = _ros_message;
  {  // object
    PyObject * field = PyObject_GetAttrString(_pymsg, "object");
    if (!field) {
      return false;
    }
    if (!objects_msgs__msg__object__convert_from_py(field, &ros_message->object)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
  ...
  {  // prediction
    ...
    geometry_msgs__msg__PoseStamped * dest = ros_message->prediction.data;
  ...
  {  // trajectory
    ...
    geometry_msgs__msg__PointStamped * dest = ros_message->trajectory.data;
    for (Py_ssize_t i = 0; i < size; ++i) {
...
PyObject * objects_msgs__msg__dynamic_object__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("objects_msgs.msg._dynamic_object");
  ...
  {  // object
    PyObject * field = NULL;
    field = objects_msgs__msg__object__convert_to_py(&ros_message->object);
    if (!field) {
      return NULL;
    }
    {
  ...
  {  // prediction
    ...
    for (size_t i = 0; i < size; ++i) {
      item = &(ros_message->prediction.data[i]);
