...
static const _DynamicObjectArray_type_support_symbol_names_t _DynamicObjectArray_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, objects_msgs, msg, DynamicObjectArray)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, objects_msgs, msg, DynamicObjectArray)),
  }
};
...
{
  return &::objects_msgs::msg::rosidl_typesupport_cpp::DynamicObjectArray_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, objects_msgs, msg, DynamicObjectArray)() {
  return get_message_type_support_handle<objects_msgs::msg::DynamicObjectArray>();
}
