...
static const _DynamicObjectArray_type_support_symbol_names_t _DynamicObjectArray_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, objects_msgs, msg, DynamicObjectArray)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, objects_msgs, msg, DynamicObjectArray)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, objects_msgs, msg, DynamicObjectArray)() {
  return &::objects_msgs::msg::rosidl_typesupport_c::DynamicObjectArray_message_type_support_handle;
}
