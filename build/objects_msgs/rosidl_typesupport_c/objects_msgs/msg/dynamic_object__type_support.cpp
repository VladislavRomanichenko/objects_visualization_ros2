...
static const _DynamicObject_type_support_symbol_names_t _DynamicObject_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, objects_msgs, msg, DynamicObject)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, objects_msgs, msg, DynamicObject)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, objects_msgs, msg, DynamicObject)() {
  return &::objects_msgs::msg::rosidl_typesupport_c::DynamicObject_message_type_support_handle;
}
