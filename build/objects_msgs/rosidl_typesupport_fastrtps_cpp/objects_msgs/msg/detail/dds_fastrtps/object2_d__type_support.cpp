...
#include "objects_msgs/msg/detail/object2_d__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const objects_msgs::msg::Object2D & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  objects_msgs::msg::Object2D & ros_message)
{
  // Member: id
  cdr >> ros_message.id;
...
{
  auto typed_message =
    static_cast<const objects_msgs::msg::Object2D *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<objects_msgs::msg::Object2D *>(
    untyped_ros_message);
...
{
  return max_serialized_size_Object2D(full_bounded, 0);
}
...
{
  return &objects_msgs::msg::typesupport_fastrtps_cpp::_Object2D__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, objects_msgs, msg, Object2D)() {
  return &objects_msgs::msg::typesupport_fastrtps_cpp::_Object2D__handle;
}
