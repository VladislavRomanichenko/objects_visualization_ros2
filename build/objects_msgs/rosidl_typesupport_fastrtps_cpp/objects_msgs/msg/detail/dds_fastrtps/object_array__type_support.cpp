...
#include "objects_msgs/msg/detail/object_array__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  auto typed_message =
    static_cast<const objects_msgs::msg::ObjectArray *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<objects_msgs::msg::ObjectArray *>(
    untyped_ros_message);
...
{
  return &objects_msgs::msg::typesupport_fastrtps_cpp::_ObjectArray__handle;
}
