...
#include "objects_msgs/msg/detail/object_array__rosidl_typesupport_fastrtps_c.h"
...
#include "objects_msgs/msg/detail/object__functions.h"  // objects
...
using _ObjectArray__ros_msg_type = objects_msgs__msg__ObjectArray;
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: objects
  {
    ...
    if (ros_message->objects.data) {
      objects_msgs__msg__Object__Sequence__fini(&ros_message->objects);
    }
...
size_t get_serialized_size_objects_msgs__msg__ObjectArray(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _ObjectArray__ros_msg_type * ros_message = static_cast<const _ObjectArray__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _ObjectArray__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_objects_msgs__msg__ObjectArray(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_objects_msgs
size_t max_serialized_size_objects_msgs__msg__ObjectArray(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  return max_serialized_size_objects_msgs__msg__ObjectArray(
    full_bounded, 0);
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, objects_msgs, msg, ObjectArray)() {
